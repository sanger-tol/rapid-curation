...
--------------------------------------------------------------------------------------------
                    First, make sure you are in the rapid environment!!!
--------------------------------------------------------------------------------------------
                              Now you can actually use things!
--------------------------------------------------------------------------------------------

 The Pretext-to-tpf have been aliased to:   "ptt"

 Run PretextView it self with:              "./PretextView &"

 The & will make life easier, and try to run it in the VScode window if possible,
 if you spend 30 minutes in the NoVNC (pretext only) window then you WILL timeout.
